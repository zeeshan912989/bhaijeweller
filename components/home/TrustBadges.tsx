...
export default function TrustBadges() {
  return (
    <section className="w-full bg-[#42210B] text-white py-5 sm:py-8 border-y border-[#52290D]">
      <div className="w-full max-w-6xl mx-auto px-3 sm:px-8">
        <div className="grid grid-cols-3 gap-2 sm:gap-8 items-center text-center">
          
          {/* 1. 2 YEAR WARRANTY */}
          <div className="flex flex-col items-center justify-center group cursor-default">
            <div className="mb-1.5 sm:mb-2.5 transition-transform duration-300 group-hover:scale-110">
              {/* Rosette Ribbon Badge with Checkmark SVG */}
              <svg className="w-5 h-5 sm:w-7 sm:h-7 stroke-white fill-none stroke-[1.4]" viewBox="0 0 24 24">
            ...
            <span
              ...
              className="text-xs sm:text-[18px] font-normal text-white/95 tracking-[0.02em] group-hover:text-[#F7E8B5] transition-colors leading-tight"
            >
              2 Year Warranty
            </span>
          </div>
