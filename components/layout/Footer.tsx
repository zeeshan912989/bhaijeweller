      ...
      <div className="w-full px-4 sm:px-8 lg:px-12 xl:px-14">
        ...
        <div className="lg:hidden pt-8 space-y-6">
          ...
          <div className="flex items-center justify-center gap-3 pt-2 pb-4">
            ...
            >
              <svg className="w-4 h-4 fill-none stroke-current stroke-[1.6]" viewBox="0 0 24 24">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full border border-neutral-400 flex items-center justify-center text-neutral-700 hover:text-black hover:border-black transition-colors text-[10px] font-bold"
              aria-label="TikTok"
            >
              TT
            </Link>
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full border border-neutral-400 flex items-center justify-center text-neutral-700 hover:text-black hover:border-black transition-colors text-[11px] font-serif font-bold"
